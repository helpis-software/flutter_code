...
/// Callers can lookup localized strings with an instance of FlutterCodeLocalizations
/// returned by `FlutterCodeLocalizations.of(context)`.
///
/// Applications need to include `FlutterCodeLocalizations.delegate()` in their app's
...
///
/// return MaterialApp(
///   localizationsDelegates: FlutterCodeLocalizations.localizationsDelegates,
///   supportedLocales: FlutterCodeLocalizations.supportedLocales,
...
/// be consistent with the languages listed in the FlutterCodeLocalizations.supportedLocales
/// property.
abstract class FlutterCodeLocalizations {
  FlutterCodeLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static FlutterCodeLocalizations of(BuildContext context) {
    return Localizations.of<FlutterCodeLocalizations>(context, FlutterCodeLocalizations)!;
  }

  static const LocalizationsDelegate<FlutterCodeLocalizations> delegate = _FlutterCodeLocalizationsDelegate();
...
class _FlutterCodeLocalizationsDelegate extends LocalizationsDelegate<FlutterCodeLocalizations> {
  const _FlutterCodeLocalizationsDelegate();

  @override
  Future<FlutterCodeLocalizations> load(Locale locale) {
    return lookupFlutterCodeLocalizations(locale);
  }
  ...
  @override
  bool shouldReload(_FlutterCodeLocalizationsDelegate old) => false;
}

Future<FlutterCodeLocalizations> lookupFlutterCodeLocalizations(Locale locale) {


  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'en': return app_localizations_en.loadLibrary().then((dynamic _) => app_localizations_en.FlutterCodeLocalizationsEn());
  }

  throw FlutterError(
    'FlutterCodeLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
